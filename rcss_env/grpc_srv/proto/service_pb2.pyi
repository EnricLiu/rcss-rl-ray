...
class PenaltyKickState(_message.Message):
    __slots__ = ("on_field_side", "current_taker_side", "our_taker_counter", "their_taker_counter", "our_score", "their_score", "is_kick_taker", "cycle")
    ...
    is_kick_taker: bool
    cycle: int
    def __init__(self, on_field_side: _Optional[_Union[Side, str]] = ..., current_taker_side: _Optional[_Union[Side, str]] = ..., our_taker_counter: _Optional[int] = ..., their_taker_counter: _Optional[int] = ..., our_score: _Optional[int] = ..., their_score: _Optional[int] = ..., is_kick_taker: bool = ..., cycle: _Optional[int] = ...) -> None: ...

class Player(_message.Message):
    __slots__ = ("position", "seen_position", "heard_position", "velocity", "seen_velocity", "pos_count", "seen_pos_count", "heard_pos_count", "vel_count", "seen_vel_count", "ghost_count", "dist_from_self", "angle_from_self", "id", "side", "uniform_number", "uniform_number_count", "is_goalie", "body_direction", "body_direction_count", "face_direction", "face_direction_count", "point_to_direction", "point_to_direction_count", "is_kicking", "dist_from_ball", "angle_from_ball", "ball_reach_steps", "is_tackling", "type_id", "inertia_final_point", "body_count")
    POSITION_FIELD_NUMBER: _ClassVar[int]
    SEEN_POSITION_FIELD_NUMBER: _ClassVar[int]
    HEARD_POSITION_FIELD_NUMBER: _ClassVar[int]
    VELOCITY_FIELD_NUMBER: _ClassVar[int]
    ...
    INERTIA_FINAL_POINT_FIELD_NUMBER: _ClassVar[int]
    BODY_COUNT_FIELD_NUMBER: _ClassVar[int]
    position: RpcVector2D
    seen_position: RpcVector2D
    heard_position: RpcVector2D
    velocity: RpcVector2D
...
class Self(_message.Message):
    ...
    GET_SAFETY_DASH_POWER_FIELD_NUMBER: _ClassVar[int]
    position: RpcVector2D
    seen_position: RpcVector2D
    heard_position: RpcVector2D
    velocity: RpcVector2D
...
class PlayerAction(_message.Message):
    ...
    BHV_GOALIE_FREE_KICK_FIELD_NUMBER: _ClassVar[int]
    dash: Dash
    turn: Turn
    kick: Kick
    tackle: Tackle
