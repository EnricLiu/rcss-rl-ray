...
class TrainConfig(BaseModel):
    ...
    def _move_curriculum_keys(data: dict[str, Any]) -> None:
        ...
        mapping = {
            ...
            "goal_l": "goal_l",
            "goal_r": "goal_r",
            "allow_stale_agent_states": "allow_stale_agent_states",
            "state_fetch_timeout_s": "state_fetch_timeout_s",
            "reset_state_fetch_timeout_s": "reset_state_fetch_timeout_s",
            "truth_fetch_timeout_s": "truth_fetch_timeout_s",
            "partial_state_min_unums": "partial_state_min_unums",
            "max_stale_state_cycles": "max_stale_state_cycles",
